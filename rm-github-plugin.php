<?php
/**
 * Plugin Name:  RM Plugin Updater
 * Version:      2.1.1
 * Description:  A professional plugin with GitHub update integration.
 * Author:       Plugin updater
 * GitHub:      https://github.com/rosewoodmarketing/rm-plugin-updater
 */
...
if ( is_admin() && class_exists( '\RM_GitHub_Plugin_RMPU\Updater' ) ) {
    new \RM_GitHub_Plugin_RMPU\Updater();
}
